...
ZIP_FILE="$LAMBDA_DIR/okvevo-ai-prep.zip"

echo "📦 Building okvevo-ai-prep Lambda deployment package..."
echo ""
...
echo "   2. Or use AWS CLI: aws lambda update-function-code --function-name okvevo-ai-prep --zip-file fileb://$ZIP_FILE --region us-east-1"
