...
- [ ] `MONO = "JetBrains Mono"` set as the font constant (fallbacks: `"Space Mono"`, `"DejaVu Sans Mono"`)
...
counter = DecimalNumber(0, font_size=48, num_decimal_places=0, font="JetBrains Mono")
