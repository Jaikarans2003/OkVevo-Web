...
## OKVEVO path mapping
This agent has no Cursor skill picker. When this skill says read `/hyperframes-core` (or any `/workflow-name`), use `read_file` on `Skills/hyperframes/<name>/SKILL.md`.
