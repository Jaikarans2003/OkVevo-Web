...
import { incrementBlogViews, formatDate } from '@/lib/blogUtils';
...
export default function BlogView({ blog, relatedBlogs }: BlogViewProps) {
    const [user, setUser] = useState<any>(null);

    useEffect(() => {
        // Increment view counter on client mount
            ...
            <div className="relative z-10">
                ...
                <div className="w-full relative h-[400px] md:h-[600px] rounded-[2.5rem] overflow-hidden mb-16 bg-white/[0.02] border border-white/5 p-4 lg:p-6 backdrop-blur-md shadow-2xl transition-all duration-500 hover:border-white/10 group">
                    <img
                        ...
                        alt={blog.title}
                        className="w-full h-full object-cover rounded-[1.5rem] md:rounded-[2rem] group-hover:scale-105 transition-transform duration-1000 ease-[transition-timing-function:cubic-bezier(0.25,0.46,0.45,0.94)]"
                    />
                        ...
                        <div className="sticky top-32">
                            <div className="mb-12">
                                ...
                                <p className="text-sm text-white/60 leading-relaxed mb-6">
                                    Insights and updates from the OKVEVO team on AI video creation and social media trends.
                                </p>
                            </div>
