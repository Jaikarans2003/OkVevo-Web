...
const TuneTalez = () => {
    return (
        <section id="tunetalez" data-section-theme="light" className="section-padding overflow-hidden bg-bg-main relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-accent-orange/20 rounded-full blur-[60px] pointer-events-none transform-gpu" />
                ...
                >
                    ...
                    <div className="aspect-[16/9] rounded-[48px] overflow-hidden shadow-premium bg-gradient-to-br from-accent-orange/5 via-accent-sky/5 to-accent-lavender/5 relative group">
                        ...
                        <motion.div
                            ...
                            className="absolute top-12 right-12 glass-card p-6 rounded-[32px] border-accent-orange/20 transform-gpu"
                        >
