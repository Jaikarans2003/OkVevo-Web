...
aws lambda update-function-configuration --function-name okvevo-renderer --region $Region --environment "Variables={$CommonVars,GEMINI_API_KEY=$GEMINI_KEY}"
...
Write-Host "`nAll Lambdas configured with environment variables."
